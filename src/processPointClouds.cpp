...
{
    // Calculated the 3D centroid of the cluster
    ...
    // replace the 3rd eigen vector with the cross product of the first two
    ...
    box.bboxQuaternion = Eigen::Quaternionf(bboxQuaternion.w(), 0, 0, 1);
